...
def main(api_key, query, max_results=50, filename="processed_video_ids.txt", output_file="C:/Users/soo/Desktop/soo/2024/env_capstone/youtubeAPI_soo_00.xlsx"):
    processed_video_ids = load_processed_video_ids(filename)
    existing_video_ids = load_existing_video_ids_from_excel(output_file)

    # 날짜 범위 설정
    date_ranges = [
        ("2010-01-01T00:00:00Z", "2010-12-31T23:59:59Z"),
        ("2011-01-01T00:00:00Z", "2011-12-31T23:59:59Z"),
        ("2012-01-01T00:00:00Z", "2012-12-31T23:59:59Z"),
